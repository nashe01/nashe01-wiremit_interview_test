...
import { ArrowRight, Users, Building2, Globe, Star, Zap, Shield } from 'lucide-react';
...
const LandingPage: React.FC = () => {
  ...
  const stats = [
    { icon: Users, label: 'Personal Users', value: '2.5M+' },
    { icon: Building2, label: 'Business Users', value: '150K+' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Join our global community of satisfied customers
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="text-center card-elevated bg-background"
                >
